Arcade::Application.routes.draw do
  ...
  get '/paper-scissors-rock' => 'paper_scissors_rock#index', :as => :paper_scissors_rock

  get '/paper-scissors-rock/:play' => 'paper_scissors_rock#play', :as => :paper_scissors_rock_play
